  ...
  return (
    <div className="mb-8">
      ...
      <div className="flex justify-between text-sm mt-2">
        <span className={`${currentStep >= 1 ? "text-[#6445E8] text-base font-semibold" : "text-muted-foreground"}`}>Gadget details</span>
        <span className={`${currentStep >= 2 ? "text-[#6445E8] text-base font-semibold" : "text-muted-foreground"}`}>Pickup & Delivery</span>
        <span className={`${currentStep === 3 ? "text-[#6445E8] text-base font-semibold" : "text-muted-foreground"}`}>Review</span>
      </div>
    </div>
  );
};
