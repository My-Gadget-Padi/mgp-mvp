  ...
  return (
    <section className="relative lg:h-screen lg:overflow-hidden md:h-auto sm:h-auto sm:overflow-none">
      <div className="lg:flex mx-auto">
        ...
        <div className="lg:w-6/12 mt-6 sm:mt-0 w-full pr-4 pl-4 sm:pr-0 sm:pl-0 sm:w-full bg-white dark:bg-dark sm:p-[60px] relative">
          <button
            type="button"
            className="hidden sm:block border-2 border-black rounded-lg absolute right-6 top-3 px-5 py-2"
          >
