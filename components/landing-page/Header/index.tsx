      ...
      >
        <div className="container">
          <div className="relative -mx-4 flex items-center justify-between">
            <div className="w-60 flex items-center px-1 xl:mr-10">
              <Link
                href="/"
            ...
            <div className="flex w-full items-center justify-between px-4 py-2">
              <div>
                <button
                  ...
                  className="absolute right-4 top-1/2 block translate-y-[-50%] rounded-lg px-3 py-[6px] focus:border-indigo-700 lg:hidden"
                >
                  <span
                          ...
                          <Link
                            ...
                            className={`flex py-2 text-base lg:mr-0 lg:inline-flex lg:px-0 lg:py-6 ${
                              usePathName === menuItem.path
                                ...
                                : "text-dark hover:text-indigo-700 dark:text-white/70 dark:hover:text-white"
                            }`}
                          >
                            {menuItem.title}
                          </Link>
