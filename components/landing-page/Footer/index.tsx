          ...
          <div className="w-full text-white flex flex-wrap justify-center">
            <div className="text-center lg:w-6/12 mb-10">
              ...
              <p className="text-sm font-light mt-5 ">
                {" "}
                This is a text, don&apos;t read except you&apos;re one... I
                caught you reading this, better stop now or the next line is
                going to hit you really well. You are smart
              </p>
            </div>
          </div>

          <div
            className="lg:mb-15 sm:mb-5 lg:w-full text-center sm:w-6/12"
            style={styles.bgImg}
          ></div>
