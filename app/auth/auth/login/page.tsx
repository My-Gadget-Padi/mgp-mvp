...
export const metadata: Metadata = {
  title: "Login In page ",
  description: "This is Login into Mgp dashboard",
  // other metadata
};
      ...
      <section className="relative lg:h-screen lg:overflow-hidden md:h-auto sm:h-auto sm:overflow-none">
        <div className="lg:flex mx-auto">
          ...
          <div className="lg:w-6/12 sm:w-full bg-white  dark:bg-dark sm:p-[60px] relative">
            <button className="border-2 border-black rounded-lg absolute right-6 top-3 py-3 px-5"><Link href="/auth/signup" >Create Account</Link></button>
            ...
            <p className="text-base text-center py-1 text-gray-500 font-light"> Forget password</p>
